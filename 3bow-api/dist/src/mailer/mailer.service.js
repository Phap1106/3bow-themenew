...
const nmMaybe = (_a = _nm === null || _nm === void 0 ? void 0 : _nm.default) !== null && _a !== void 0 ? _a : _nm;
let MailerService = class MailerService {
    ...
    async ensureTransporter() {
        ...
        if (!nodemailer) {
            const mod = await Promise.resolve().then(() => require('nodemailer'));
            nodemailer = (_a = mod.default) !== null && _a !== void 0 ? _a : mod;
        }
