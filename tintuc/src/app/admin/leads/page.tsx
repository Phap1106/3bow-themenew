                ...
                <tbody className="divide-y divide-zinc-100">
                  {loading ? (
                    ...
                    data.items.map((l, idx) => (
                      <tr key={l.id} className="transition-colors odd:bg-white even:bg-zinc-50/40 hover:bg-amber-50/40">
      ...
      {detail && (
        <div className="fixed inset-0 z-50">
          ...
          <aside className="absolute top-0 right-0 w-full h-full max-w-xl overflow-y-auto bg-white shadow-2xl">
            <div className="sticky top-0 flex items-center justify-between px-5 py-3 border-b bg-white/90 backdrop-blur">
              <div>
